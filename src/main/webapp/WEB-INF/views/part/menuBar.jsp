			...
			<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">시리얼 관리 <span class="caret"></span></a>
					...
					<li class="active"><a href="/app/product/registration">시리얼
							등록<span class="sr-only"></span>
					</a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="/app/member/myInfo" class="btn btn-default btn-flat">내 정보</a>
								</div>
